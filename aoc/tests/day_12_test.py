from aoc.day_12 import run, get_areas, get_perimeters, convert_to_list
...
test_data_small_list = convert_to_list(TEST_DATA_SMALL)
test_data_med_list = convert_to_list(TEST_DATA_MED)
